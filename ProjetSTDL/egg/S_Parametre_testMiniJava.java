...
int [] sync= new int[0];
  ...
  private void regle15() throws Exception {
	...
	//appel
if  (att_eval)	  action_auto_inh_15(x_2, x_3);
	x_2.analyser() ;
	x_3.analyser(LEX_testMiniJava.token_identificateur);
if  (att_eval)	  action_ast_15(x_2, x_3);
  }
private void action_ast_15(S_Type_testMiniJava x_2, T_testMiniJava x_3) throws Exception {
try {
// instructions
...
private void action_auto_inh_15(S_Type_testMiniJava x_2, T_testMiniJava x_3) throws Exception {
try {
// instructions
