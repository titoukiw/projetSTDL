...
public class S_SuiteHeritageGenericite_testMiniJava {
LEX_testMiniJava scanner;
  S_SuiteHeritageGenericite_testMiniJava() {
	}
  S_SuiteHeritageGenericite_testMiniJava(LEX_testMiniJava scanner, boolean eval) {
...
if  (att_eval)	  action_ast_28();
  ...
  private void regle27() throws Exception {
	...
	//appel
if  (att_eval)	  action_auto_inh_27(x_3, x_4, x_5);
	x_2.analyser(LEX_testMiniJava.token_adresse);
	x_3.analyser(LEX_testMiniJava.token_identificateur_type);
	x_4.analyser() ;
	x_5.analyser() ;
if  (att_eval)	  action_ast_27(x_3, x_4, x_5);
  }
private void action_ast_27(T_testMiniJava x_3, S_InstanceGenericite_testMiniJava x_4, S_SuiteHeritageGenericite_testMiniJava x_5) throws Exception {
try {
// locales
...
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "testMiniJava", "#ast","SuiteHeritageGenericite -> adresse identificateur_type InstanceGenericite SuiteHeritageGenericite1 #ast ;", e });
}
  }
private void action_ast_28() throws Exception {
try {
// instructions
this.att_ast= new LinkedList<Objet>();
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "testMiniJava", "#ast","SuiteHeritageGenericite -> #ast ;", e });
}
  }
private void action_auto_inh_27(T_testMiniJava x_3, S_InstanceGenericite_testMiniJava x_4, S_SuiteHeritageGenericite_testMiniJava x_5) throws Exception {
try {
// instructions
...
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "testMiniJava", "#auto_inh","SuiteHeritageGenericite -> adresse identificateur_type InstanceGenericite SuiteHeritageGenericite1 #ast ;", e });
}
  }
  public void analyser () throws Exception {
    scanner.lit ( 1 ) ;
    switch ( scanner.fenetre[0].code ) {
      case LEX_testMiniJava.token_adresse : // 49
        regle27 () ;
      break ;
