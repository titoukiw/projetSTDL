...
private void action_auto_inh_40(S_SuiteTypeAtomique_testMiniJava x_5) throws Exception {
try {
// instructions
...
private void action_inhArray_40(S_SuiteTypeAtomique_testMiniJava x_5) throws Exception {
try {
// instructions
...
private void action_ast_40(S_SuiteTypeAtomique_testMiniJava x_5) throws Exception {
try {
// instructions
...
this.att_ast=this.att_innerArray;
  ...
  public void analyser () throws Exception {
    ...
    switch ( scanner.fenetre[0].code ) {
      case LEX_testMiniJava.token_crochet_ouvrant : // 29
        regle40 () ;
      break ;
      case LEX_testMiniJava.token_identificateur : // 81
        regle41 () ;
      break ;
      default :
